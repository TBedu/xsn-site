...
function get_motd(ip,port,motd,motd_json){
	if( ip==='mc521.cc' && port==='25565' ){
		...
		return '<div class="flex"><div class="layui-panel ly-motd-bg"><div style="padding:5px" class="motd-nosupport"><span>此服务器 MOTD 获取暂不支持<p>你可点击右侧按钮查询支持列表</p></span></div></div><button type="button" class="layui-btn motd-btn md-1" lay-on="motd-tip">点击打开提示</button></div>'
	}
}
/* --- 解析函数 End --- */